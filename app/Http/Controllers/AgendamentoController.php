...
class AgendamentoController extends AppBaseController
{
    ...
    {
        $this->agendamentoRepository->pushCriteria(new RequestCriteria($request));
    ...
    {
        $agendamento = $this->agendamentoRepository->findWithoutFail($id);

        if (empty($agendamento)) {
            Flash::error('Agendamento not found');
    ...
    public function update($id, UpdateAgendamentoRequest $request)
    {
        ...
        Flash::success('Agendamento updated successfully.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Agendamento deleted successfully.');
